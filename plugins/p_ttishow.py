...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [
            [
                InlineKeyboardButton('💠 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 💠', url='https://t.me/metrohdmovies')
            ],
            [
                InlineKeyboardButton('♻️ 𝐇𝐄𝐋𝐏 ♻️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]
            ]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>Thankyou For Adding Me In {message.chat.title} ❣️\n\nIf You Have Any Questions & Doubts About Using this bot Contact Me On Support Group ›› @MetroHDmovies</b>",
            reply_markup=reply_markup)
    else:
